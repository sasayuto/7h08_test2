...
const float AirshipPropellerSupportLeft::FALL_SPEED_ACCELERATION	(0.12f / 60);	//落下の加速度			(m/s)
const float AirshipPropellerSupportLeft::EXPLOSIVE_ROTATE			(120.0f / 60);	//モデルの回転の速さ	(°/s）
const float AirshipPropellerSupportLeft::EXPLOSIVE_RANDOM_POWER(1.4f / 60);		//爆発の横のパワー		(m/s)
const float AirshipPropellerSupportLeft::EXPLOSIVE_POWER(2.0f / 60);		//爆発の横のパワー		(m/s)
