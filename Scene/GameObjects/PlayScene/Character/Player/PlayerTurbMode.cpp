#include "pch.h"
#include"PlayerTurbMode.h"
#include <math.h>
using namespace DirectX;


PlayerTurbMode::PlayerTurbMode(
	Player* motions, 
...
void PlayerTurbMode::Initialize()
{
	////リスポーン地点に位置をセット
...
void PlayerTurbMode::Update(const float& elapsedTime)
{
	elapsedTime;
...
void PlayerTurbMode::Finalize()
{
}

void PlayerTurbMode::Motion(const float& elapsedTime)
{
	...
	//燃料を減らす
	m_pPlayer->SetFuel(m_pPlayer->GetFuel() - 3);
	...
	//スピード上限
	if (speed <= Player::PLAYER_MAX_SPEED)
	{
