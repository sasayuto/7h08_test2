...
const float TurretCancer_Right::FALL_SPEED_ACCELERATION	(0.12f / 60);	//落下の加速度			(m/s)
const float TurretCancer_Right::EXPLOSIVE_ROTATE			(120.0f / 60);	//モデルの回転の速さ	(°/s）
const float TurretCancer_Right::EXPLOSIVE_RANDOM_POWER(1.4f / 60);		//爆発の横のパワー		(m/s)
const float TurretCancer_Right::EXPLOSIVE_POWER(2.0f / 60);		//爆発の横のパワー		(m/s)
const float TurretCancer_Right::BULLET_COOL_TIME(2.0f);		//球クールタイム	(s)
