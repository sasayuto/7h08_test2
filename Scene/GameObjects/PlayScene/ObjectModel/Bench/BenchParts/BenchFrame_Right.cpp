...
const float BenchFrame_Right::FALL_SPEED_ACCELERATION(0.18f / 60);	//落下の加速度			(m/s)
const float BenchFrame_Right::EXPLOSIVE_ROTATE			(50.0f / 60);	//モデルの回転の速さ	(°/s）
const float BenchFrame_Right::EXPLOSIVE_RANDOM_POWER(1.4f / 60);		//爆発の横のパワー		(m/s)
const float BenchFrame_Right::EXPLOSIVE_POWER(2.0f / 60);		//爆発の横のパワー		(m/s)
