...
/// ボディークラスを定義する
/// </summary>
class FenceNailPlank_Center_01 : public MoveObjectsComponent
{
public:
...
class FenceNailPlank_Center_02 : public MoveObjectsComponent
{
public:
	static const float FALL_SPEED_ACCELERATION;		//落下の加速度		(m/s)
	static const float EXPLOSIVE_ROTATE;		//モデルの回転の速さ(°/s）
...
class FenceNailPlank_Center_03 : public MoveObjectsComponent
{
public:
	static const float FALL_SPEED_ACCELERATION;		//落下の加速度		(m/s)
	static const float EXPLOSIVE_ROTATE;		//モデルの回転の速さ(°/s）
