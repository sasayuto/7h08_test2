...
void Particle::LoadTexture(ID3D11ShaderResourceView* texture)
{	
...
void Particle::Create(ID3D11ShaderResourceView* Texture)
{	
...
void Particle::Add(ParticleUtility* particleUtility)
{
...
void Particle::Render()
{
	...
	{
		if(Draw::GetInstance()->VisibilityRange(li.GetPosition())) continue;
