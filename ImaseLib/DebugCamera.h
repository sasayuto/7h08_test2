...
namespace Imase
{
	...
	class DebugCamera
	{
		...
		DirectX::SimpleMath::Vector3 m_keepTargetPosition;
	...
	public:
		...
		void Update(const DirectX::Mouse::ButtonStateTracker& tracker, const DirectX::Keyboard::KeyboardStateTracker& kbtracker, DirectX::SimpleMath::Vector3 selectTarget);
