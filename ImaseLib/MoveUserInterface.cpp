...
DirectX::SimpleMath::Vector2 tito::MoveUserInterface::TexPositionCalculation()
{
	return TexPositionCorrection(m_position, m_textureWidth, m_textureHeight, m_scale, m_anchor, m_positionAnchor);
}

DirectX::SimpleMath::Vector2 tito::MoveUserInterface::TexSizeCalculation()
{
...
/// インプットレイアウト
/// </summary>
const std::vector<D3D11_INPUT_ELEMENT_DESC> tito::MoveUserInterface::INPUT_LAYOUT =
{
...
/// コンストラクタ
/// </summary>
tito::MoveUserInterface::MoveUserInterface()
	:m_windowHeight(0)
	,m_windowWidth(0)
	,m_textureHeight(0)
	,m_textureWidth(0)
...
void tito::MoveUserInterface::LoadTexture(const wchar_t* path)
{
...
void tito::MoveUserInterface::Create(const wchar_t* path
...
void tito::MoveUserInterface::SetScale(DirectX::SimpleMath::Vector2 scale)
{
	m_scale = scale;
}
void tito::MoveUserInterface::SetPosition(DirectX::SimpleMath::Vector2 position)
{
	m_position = position;
}
/// <summary>
/// Shader作成部分だけ分離した関数
/// </summary>
void tito::MoveUserInterface::CreateShader()
{
	auto device = SingletonDeviceResources::GetInstance()->GetDeviceResources()->GetD3DDevice();
...
/// 描画関数
/// </summary>
void tito::MoveUserInterface::Render()
{
	auto context = SingletonDeviceResources::GetInstance()->GetDeviceResources()->GetD3DDeviceContext();
	// 頂点情報
	// Position.xy	:拡縮用スケール
	...
	ConstBuffer cbuff;
	cbuff.windowSize = SimpleMath::Vector4(static_cast<float>(m_windowWidth), static_cast<float>(m_windowHeight), m_brightness, 1);
